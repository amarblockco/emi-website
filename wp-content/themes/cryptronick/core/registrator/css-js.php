...
if (!function_exists('cryptronick_css_js_register')) {
    function cryptronick_css_js_register()
    {
		...
		wp_enqueue_script( 'cryptronick-likes-public', get_template_directory_uri() . '/js/bpt_likes.js', array( 'jquery' ), '0.5', false );
        wp_localize_script( 'cryptronick-likes-public', 'simpleLikes', array(
