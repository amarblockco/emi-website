	...
	class Cryptronick_get_header{
		...
		*/
        public static function get_logo($row = null){
            ...
            $logo_max_height = Cryptronick_Theme_Helper::get_option('logo_max_height');
            $sticky_logo_height = Cryptronick_Theme_Helper::get_option('sticky_logo_height');
            $sticky_logo_height = $sticky_logo_height['height'];

            // height for logo
            $header_height = Cryptronick_Theme_Helper::get_option('header'.$row.'_height', Cryptronick_Theme_Helper::header_preset_name());
            $header_height = isset($header_height['height']) ? $header_height['height'] : "";
            ...
            $logo = "";
            $logo .= "<div class='bpt-logotype-container".$logo_class.
